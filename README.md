...
<h3> 🏗️ มีบางอุปกรณ์ที่เลือกใช้ใหม่ </h3>

<h4> 🛠️ การออกแบบโครงสร้าง </h4>
...
<p align="center">
  <img src="images/encoder.jpg" width="300">
</p>
ภาพตัวอย่างลำดับพิน ซึ่งจริงๆใช้ 5v สำหรับ encoder
<h4> การจูน PID </h4>
STEP1 Kp <br>
ค่อยๆเพิ่มค่า Kp ไปจนกระทั่งสั่นไปสั่นและเด้งกลับได้ <br>
จากนั้นให้ลดลงจนกระทั่งหุ่นยนต์เกือบจะทรงตัวได้ด้วยมือของเรา <br>
STEP2 Kd <br>
สำหรับ Kd จะช่วยทำเหมือนเป็นเบรคให้แก่หุ่นยนต์ก่อนจะถึง setpoint <br>
แต่ถ้าใส่ค่านี้มากเกินไปก็ทำให้หุ่นยนต์สั่นมาก <br>
STEP3 Ki <br>
จากโค้ดนั้นได้กำหนดเรื่อง sample time ทำให้ค่า Ki ต้องเพิ่มมากกว่าปกติจนถึงเป็นร้อยได้ <br>
Ki จัดการ steady state error ให้เข้าสู่ setpoint ได้ใกล้เคียงที่สุด <br>
<br>
แต่สุดท้ายแล้วยังไงก็สู้การมี encoder มาช่วยจัดการตำแหน่งดีกว่า<br>

## ⚙️ การจูน PID (PID Tuning Process)

การหาค่าที่เหมาะสมเพื่อให้หุ่นยนต์ทรงตัวได้นิ่งที่สุด มีขั้นตอนดังนี้:

### 🔹 STEP 1: $K_p$ (Proportional)
* **Action:** ค่อยๆ เพิ่มค่า $K_p$ จนกระทั่งหุ่นยนต์เริ่มสั่นไปมาและเด้งกลับได้เอง
* **Fine-tuning:** จากนั้นให้ลดค่าลงเล็กน้อย จนกระทั่งหุ่นยนต์เกือบจะทรงตัวได้ด้วยมือของเรา (เกือบจะ Balance ได้เอง)

### 🔹 STEP 2: $K_d$ (Derivative)
* **Action:** ค่า $K_d$ จะทำหน้าที่เสมือน **"เบรก"** เพื่อลดการโอเวอร์ชูตก่อนจะถึงจุด Setpoint
* **Caution:** ⚠️ หากใส่ค่านี้มากเกินไป จะทำให้หุ่นยนต์เกิดการสั่นสะเทือนถี่ๆ (High-frequency oscillation)

### 🔹 STEP 3: $K_i$ (Integral)
* **Action:** ใช้จัดการกับ **Steady State Error** เพื่อให้หุ่นยนต์เข้าสู่จุดสมดุลได้แม่นยำที่สุด
* **Note:** เนื่องจากมีการกำหนด *Sample Time* ในโค้ด อาจต้องเพิ่มค่า $K_i$ ไปจนถึงหลักร้อยเพื่อให้เห็นผล

---

### 🚀 Conclusion & Improvement
สุดท้ายแล้ว แม้จะจูน PID ได้ดีแค่ไหน **"การมี Encoder"** เข้ามาช่วยจัดการตำแหน่ง (Position Control) จะช่วยให้หุ่นยนต์นิ่งและสู้แรงผลักได้ดีกว่าการใช้แค่ IMU เพียงอย่างเดียว
